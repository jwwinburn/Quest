...
",
            ...
            System.Console.WriteLine("Would you like to go on another adventure? Yes or No?");
            
            var playAgain = Console.ReadLine();
            var upperCasePlayAgain = playAgain.ToUpper();
            if (upperCasePlayAgain == "Y" || upperCasePlayAgain == "YES")
            {
                repeat = true;
            }
            else
